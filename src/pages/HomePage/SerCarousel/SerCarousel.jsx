        ...
        >
          <div className="w-full relative flex items-center justify-center">
            <ButtonBack
              ...
              className="px-5 py-4 rounded-full bg-slate-300 absolute z-30 left-0 ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer"
              id="prev"
            >
              <svg
                width={8}
            ...
            <ButtonNext
              ...
              className="px-5 py-4 rounded-full bg-slate-300 absolute z-30 right-0 mr-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
              id="next"
            >
              <svg
                width={8}
