...
const SearchPage = () => {
  ...
  const fetchCongViecTheoTen = async () => {
    try {
      const data = await congViecSer.searchByName(tenCongViec);
      console.log(data);
  ...
  const renderItem = () => {
    if (congViec == "") {
      return (
        <h3 className=" col-span-12 text-3xl my-20 text-center font-bold">
